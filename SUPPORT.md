...
Thanks for using rogtemplate! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/rOpenGov/rogtemplate/issues/new).
...
requests](https://github.com/rOpenGov/rogtemplate/issues) to make sure
