# Contributing to rogtemplate

This guide explains how to propose a change to **rogtemplate**. Review
the [development contributing guide](https://rstd.io/tidy-contrib) and
[code review principles](https://code-review.tidyverse.org/) before
...
- Fork the package and clone it onto your computer. If you have not done
  this before, use
  `usethis::create_from_github("rOpenGov/rogtemplate", fork = TRUE)`.
...
Please note that the **rogtemplate** project is released with a
[Contributor Code of
Conduct](https://ropengov.github.io/rogtemplate/CODE_OF_CONDUCT.md). By
