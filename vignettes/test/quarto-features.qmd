...
description: "Test pkgdown rendering for representative Quarto features."
subtitle: Use shortcodes
output: html
knitr:
  opts_chunk:
    collapse: true
...
[^3]: Inline notes are easier to write because you do not have to pick an
