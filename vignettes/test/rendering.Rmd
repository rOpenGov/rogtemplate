...
<summary>Some <strong>R</strong> code</summary>
...
```{r}
#| jarl-ignore-chunk:
#|   - internal_function: Exercise pkgdown's rendering helper.
pkgdown:::ruler()
...
#| jarl-ignore-chunk:
#|   - unreachable_code: R Markdown chunks execute independently.
plot(1:42)
```
